...
<head>
    ...
    <title>Edit Kamar - KostHunt</title>
    ...
    <div class="container" style="max-width: 800px;
        ...
        <div class="card">
            <div class="card-header">
                <h3><i class="fas fa-edit"></i> Edit Kamar Nomor: <%= room.getNumber() %></h3>
            </div>
            <div class="card-body">
                <%
                ...
                <form action="<%= request.getContextPath() %>/editRoom" method="post">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="<%= request.getContextPath() %>/roomList?kostId=<%= room.getKostId() %>" class="btn btn-secondary">
